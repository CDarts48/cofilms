                    ...
                    <section style={styles.section}>
                        ...
                        {showPastEpisodes && (
                            <div style={{ marginTop: '2rem' }}>
                                                        <div style={styles.episodeCard}>
                            <h3 style={styles.episodeTitle}>Episode 6: Conversation with Justin McClure</h3>
                            <p style={styles.episodeDescription}>
                                Justin McClure, a filmmaker from South Carolina and a veteran of the United States Air Force who served in Turkey and in Okinawa, Japan. Justin separated from the military to pursue film, graduated summa cum laude from CU Boulder in cinema studies, and recently released their first independently funded film, <i>Mad Man Maddox</i>, about a Colorado pro wrestler named Dorian Richard. Justin McClure expressed enthusiasm for discussing films and the projects they have created.
                            </p>
                            <p style={styles.listenLabel}>Listen here:</p>
                            <div style={styles.buttonGroup}>
                                <a
